...
import { ChevronRight, Copy, Github, Home, Smartphone, Code, Eye, Terminal } from "lucide-react"
  ...
  return (
    ...
    preview: (
      <div className="bg-white border rounded-lg p-4 shadow-sm">
        ...
        <p className="text-sm">
          This is the main content of the card. You can put any content here including images, buttons, or other
          components.
        </p>
      </div>
    ),
...
export default function DocsPage() {
  ...
  const currentComponent = componentData[selectedComponent as keyof typeof componentData]
    ...
    <div className="flex flex-col min-h-screen">    
      ...
      <div className="flex-1 flex">
        ...
        <main className="flex-1 flex">
          ...
          <div className="flex-1 p-6">
            <div className="max-w-4xl">
              ...
              <div className="flex items-center space-x-2 text-sm text-muted-foreground mb-6">
                ...
                <span className="text-foreground">{currentComponent?.title}</span>
              </div>

              {/* Component Header */}
              <div className="mb-8">
                <h1 className="text-3xl font-bold mb-2">{currentComponent?.title}</h1>
                <p className="text-lg text-muted-foreground">{currentComponent?.description}</p>
              </div>
                ...
                <TabsContent value="code" className="mt-6">
                  <Card>
                    <CardHeader className="flex flex-row items-center justify-between">
                      ...
                      <Button variant="outline" size="sm" onClick={() => copyToClipboard(currentComponent?.code || "")}>
                ...
                <TabsContent value="preview" className="mt-6">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>This is how the component looks on mobile devices</CardDescription>
                    </CardHeader>
                    <CardContent>
                ...
                <TabsContent value="install" className="mt-6">
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      <div>
                        <h3 className="font-medium mb-2">1. Install NativeKit</h3>
                        <div className="bg-muted p-3 rounded-md font-mono text-sm">npm install nativekit</div>
                      </div>
                      <div>
                        <h3 className="font-medium mb-2">2. Import the component</h3>
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Check the code tab for usage examples and props documentation.
                        </p>
                      </div>
                    </CardContent>
                  </Card>
              ...
              {selectedComponent !== "installation" && (
                <Card className="mt-6">
                  <CardHeader>
                    ...
                    <CardDescription>Available props for the {currentComponent?.title} component</CardDescription>
                  </CardHeader>
                  <CardContent>
                      ...
                      <table className="w-full text-sm">
                        ...
                        <tbody>
                          <tr className="border-b">
                            ...
                            <td className="py-2 font-mono text-muted-foreground">string</td>
                            <td className="py-2 font-mono text-muted-foreground">"primary"</td>
                            <td className="py-2">The visual style variant</td>
                          </tr>
                          <tr className="border-b">
                            <td className="py-2 font-mono">size</td>
                            <td className="py-2 font-mono text-muted-foreground">string</td>
                            <td className="py-2 font-mono text-muted-foreground">"medium"</td>
                            <td className="py-2">The size of the component</td>
                          </tr>
                          <tr className="border-b">
                            <td className="py-2 font-mono">disabled</td>
                            <td className="py-2 font-mono text-muted-foreground">boolean</td>
                            <td className="py-2 font-mono text-muted-foreground">false</td>
                            <td className="py-2">Whether the component is disabled</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
          ...
          {!components[0].items.some((item) => item.id === selectedComponent) && (
                    ...
                    <div className="w-64 h-96 bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-2 shadow-2xl">
                      <div className="w-full h-full bg-white dark:bg-gray-100 rounded-2xl p-4 overflow-hidden">
                        <div className="text-center mb-4">
                          <h4 className="font-bold text-sm text-gray-900">NativeKit Demo</h4>
                          <p className="text-xs text-gray-600">{currentComponent?.title}</p>
                        </div>
                        <div className="space-y-3">
                          {currentComponent?.preview || (
                            <div className="text-center text-gray-500 py-8 text-sm">No preview available</div>
                          )}
                        </div>
                      </div>
                    </div>
